...
Then I click "Add Collaborators"
...
And I am on the idea page for the idea with the title "awesome new idea"
...
| title                 | user_id          | privacy      | #collaborators |
| awesome new idea      | 1                | private      | #testuser2	  |

And "testuser2" has been added as a collaborator to the idea with title "awesome new idea"
